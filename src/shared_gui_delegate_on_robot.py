    ...
    def beep_according_to_distance(self, beep_rate, beep_rate_increase):
        while True:
            ...
            if distance < 60:
                ...
                time.sleep(beep_rate / (distance * beep_rate_increase))
                if distance < 4:
    ...
    def tone_until_distance_is_less_than(self, distance_entry, speed_entry, frequency_entry, rate_entry):
        while True:
            ...
            if distance < 60:
                ...
                print(distance)
                self.robot.sound_system.tone_maker.play_tone(int(frequency_entry) + (int(distance_entry)*int(rate_entry)), 500)
